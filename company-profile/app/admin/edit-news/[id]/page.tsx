...
export default function EditNews({ params }: PageProps) {
  ...
  const { id: newsId } = React.use(params);
  ...
  useEffect(() => {
    ...
    const existingData = {
      judul: "wes bener",
      konten: "anjayy",
      existingImage: "https://placehold.co/600x400",
    };

    setFormData({
      judul: existingData.judul,
      konten: existingData.konten,
      image: null,
    });
        ...
        <main className="flex-1 p-8">
          <div className="max-w-4xl">
            ...
            <div className="mb-8">
              ...
              <h2 className="text-3xl font-bold text-gray-800">Edit Berita</h2>
            </div>
